...
public class NabrusRenderer extends MobEntityRenderer<NabrusEntity, Nabrus> {

    public NabrusRenderer(EntityRendererFactory.Context context) {
        super(context, new Nabrus(context.getPart(ModClient.EntityTestingClient.MODEL_NABRUS_LAYER)), 0.5f);
    }
